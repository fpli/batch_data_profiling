...
package com.ebay.dataquality.profiling.examples

import com.amazon.deequ.analyzers._
import com.amazon.deequ.analyzers.runners.AnalysisRunner
import com.ebay.dataquality.profiling.examples.ExampleUtils.{itemsAsDataframe, withSpark}

private[examples] object IncrementalMetricsExampleCopy extends App {
  ...
  withSpark { session =>
    ...
    val data = itemsAsDataframe(session,
      ...
      Item(2, "Thingy BB", "available tomorrow", "low", 0),
      Item(2, "Thingy BBB", "available tomorrow", "low", 0),
    ...
    val analysis = Analysis()
      .addAnalyzer(Size())
      .addAnalyzer(CountDistinct(Seq("id", "productName")))
