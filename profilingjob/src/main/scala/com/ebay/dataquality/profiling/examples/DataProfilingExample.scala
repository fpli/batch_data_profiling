...
import com.ebay.dataquality.profiling.examples.ExampleUtils.withSpark
...
private[examples] object DataProfilingExample extends App {
  ...
  withSpark { session =>
    ...
    println("Value distribution in 'totalNumberProfile':")
    totalNumberProfile.histogram.foreach {
